...
async function clearAndRewriteDatabase() {
    const inputPath = path.resolve(process.cwd(), 'appoints-afterbreak.json');
    ...
    console.log('--- STEP 2: Rewriting appointments from appoints-afterbreak.json ---');
    ...
    console.log('Finished clearing and rewriting database from appoints-afterbreak.json.');
}
